...
export default function NavBar() {
  ...
  return (
      ...
      <Navbar bg="navbar-light" expand="xxl" className="px-5" style={{backgroundColor: "#ffffff00 "}}>
        <Navbar.Brand className="d-inline-block align-top" href="/">
          <Logo />{" "}
        </Navbar.Brand>
        <Navbar.Toggle aria-controls="navbarScroll" />
        <Navbar.Collapse id="navbarScroll" className="justify-content-end ">
          <Nav className="left my-2 my-lg-0 gap-5" navbarScroll>
            <Link className="color" to="/">
              {t("nav_bar_Home")}{" "}
            </Link>
            <Link className="color" to="/Portfolio">
              {t("nav_bar_Portfolio")}{" "}
            </Link>
          </Nav>

          <div className="butonsCol gap-5">
